    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          GradientDivider(),
          const PrestationWidegtsTablet(),
          Label(
            label: S.of(context).Solution_title,
            fontsize: 45,
          ),
          const OurSolutionTablet(),
          const SizedBox(
            height: 8,
          ),
          Label(
...
class PrestationWidegtsTablet extends StatelessWidget {
  const PrestationWidegtsTablet({
    super.key,
  });
...
class OurSolutionTablet extends StatelessWidget {
  const OurSolutionTablet({
    super.key,
  });
              ...
              child: SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: SizedBox.fromSize(
                    ...
                    child: Image.asset(Image_1_phone, fit: BoxFit.fill),
                  ),
                ),
              ),
            )
...
class OurServicesTablet extends StatelessWidget {
  const OurServicesTablet({
    super.key,
  });
